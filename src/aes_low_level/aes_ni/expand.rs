// Copied with minor changes from following place under MIT license by Artyom Pavlov:
// https://github.com/RustCrypto/block-ciphers/blob/master/aes/aesni/src/aes128/expand.rs
